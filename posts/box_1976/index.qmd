...
description: |
    All models are wrong; some are useful. But why is that? In this article, we review Box's (1976) paper on the iterative process of scientific knowledge production.
author:
  - name: Felipe Lamarca
