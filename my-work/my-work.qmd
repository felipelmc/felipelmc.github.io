...
📌 [Artplan](https://artplan.com.br/): Social media data analysis with Deep Learning for user segmentation and image clustering

📌 [Fundação Roberto Marinho](https://www.frm.org.br/): AWS data lake implementation (S3, Glue, Lambda), dashboard development (Power BI, Streamlit), and training in Python and ML

📌 [CEBRAP](https://cebrap.org.br/): Technical analysis using OCR, LLMs, and quantitative research support for Prof. Dr. José Szwako (IESP-UERJ)

📌 [Plataforma CIPÓ](https://plataformacipo.org/): Instructor for data analysis and machine learning training program

📌 [GENI/UFF](https://geni.uff.br/): Built customized tools using LLMs and RAG pipelines for extracting and interacting with data
